...
public class FilterFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      /*  mViewModel1.GetFilterCookingTypes();
        StartProgress();
        mViewModel1.GetFilterplacechar();*/

        return view;
    }

    private void Observers() {
     /*   mViewModel1.filterCookType.observe(getViewLifecycleOwner(), new Observer<List<AllFillterModel.Cooking_types>>() {
            @Override
            public void onChanged(List<AllFillterModel.Cooking_types> cooking_types) {

                FilterAdapter adapter = new FilterAdapter(filterFragment, getChildFragmentManager(), getContext(), cooking_types);
        ...
        mViewModel1.filterPlaceChar.observe(getViewLifecycleOwner(), new Observer<List<AllFillterModel.Place_characteristics>>() {
            @Override
            public void onChanged(List<AllFillterModel.Place_characteristics> place_characteristicsses) {
                StartProgress();

                FilterAdapter2 adapter2 = new FilterAdapter2(filterFragment, getChildFragmentManager(), getContext(), place_characteristicsses);
                LinearLayoutManager layoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
